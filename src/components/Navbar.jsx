    ...
    return (
        <div>
            <div className="bg-black text-gray-400 h-[100px] max-w-[1200px] mx-auto flex justify-between items-center">
                <h1 className="text-3xl font-bold primary-color ml-4 font-cinzel"><img src={p} alt="" className="w-[200px]" /></h1>
                ...
                <div className={nav ? 'fixed h-full left-0 top-0 w-[60%] bg-[#202121] ease-in-out duration-500' : 'fixed left-[-100%] ease-in-out duration-500'}>
                    <h1 className="text-3xl font-bold primary-color ml-4 my-4"><img src={p} alt="" className="w-[200px]" /></h1>
